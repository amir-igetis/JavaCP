...
public class MaxProfitFromTradingStocksWithDiscounts {
    ...
    static int maxProfit(int n, int[] present, int[] future, int[][] hierarchy, int budget) {
    ...
    private static Result dfs(int u, int[] present, int[] future, List<Integer>[] g, int budget) {
        int cost = present[u], dCost = present[u] / 2;
