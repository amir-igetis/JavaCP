...
public class MaximizeTheDistBetweenPointsOnASquare {
    ...
    static int maxDistance(int side, int[][] points, int k) {
    ...
    private static boolean check(List<Long> arr, int side, int k, long limit) {
