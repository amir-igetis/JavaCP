...
public class FindTheLengthOfALinkedList {
	...
	/// Problem Statement: Given the head of a linked list, print the length of the
	/// linked list.
	...
	/// Time Complexity: O(N), we traverse the entire linked list once to find the
	/// total number of nodes.
	/// Space Complexity: O(1) , we use fixed number of pointers and variables to
