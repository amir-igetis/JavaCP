...
// deep copy of the linked list
    ...
    private static void printClonedLinkedList(Node head) {
        while (head != null) {
    ...
    // Function to insert a copy of each
// node in between the original nodes
    private static void insertCopyInBetweenI(Node head) {
        Node temp = head;
        while (temp != null) {
            Node nextElement = temp.next;
            // Create a new node with the same data
    ...
    // Function to connect random
// pointers of the copied nodes
    private static void connectRandomPointersI(Node head) {
        Node temp = head;
        while (temp != null) {
            // Access the copied node
            Node copyNode = temp.next;
    ...
    // Function to retrieve the
// deep copy of the linked list
    private static Node getDeepCopyListI(Node head) {
        Node temp = head;
        // Create a dummy node
        Node dummyNode = new Node(-1);
        // Initialize a result pointer
    ...
    // Function to clone the linked list
    static Node cloneLLI(Node head) {
        // If the original list
        // is empty, return null
        if (head == null) return null;
        ...
        // Step 1: Insert copy of
        // nodes in between
        insertCopyInBetweenI(head);
        // Step 2: Connect random
        // pointers of copied nodes
        connectRandomPointersI(head);
        // Step 3: Retrieve the deep
        // copy of the linked list
        return getDeepCopyListI(head);
    }
