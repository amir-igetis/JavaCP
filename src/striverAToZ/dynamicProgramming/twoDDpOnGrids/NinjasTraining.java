...
public class NinjasTraining {
    ...
    /// memoization tc O(n * 4 * 3) sc O(n * 4) + O(n)
    ...
    static int ninjaTrainingI(int n, int[][] points) {
        ...
        return fI(n - 1, 3, points, dp);
    }

    // Recursive function to calculate the maximum points for the ninja training
    private static int fI(int day, int last, int[][] points, int[][] dp) {
    ...
    ///  space optimized tc O(n * 4 * 3) sc O(4)
    static int ninjaTrainingII(int n, int[][] points) {
