...
public class NinjaAndHisFriends {
    ...
    private static int solve(int i, int j1, int j2, int n, int m,
                             int[][] grid, int[][][] dp) {
    ...
    static int maximumChocolatesI(int n, int m, int[][] grid) {
        // 3D DP table
        int[][][] dp = new int[n][m][m];
    ...
    static int maximumChocolatesII(int n, int m, int[][] grid) {
        // Next row dp array
