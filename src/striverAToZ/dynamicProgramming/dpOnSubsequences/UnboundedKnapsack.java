...
public class UnboundedKnapsack {
	...
	/// array and its value by
	/// the ‘val’ array. He can either include an item in its knapsack or exclude it
	/// but can’t partially have it as a fraction.
	/// We need to find the maximum value of items that the thief can steal. He can
	/// take a single item any
	...
	/// Time Complexity: O(N*W),There are N*W states therefore at max ‘N*W’ new
